...
//
#define RCSID "$Id: PXMTrojan.cc,v 1.2 2004/01/01 02:18:10 mbuna Exp $"
...
map<uint16_t, uint32_t*> PXMTrojan::sConnCountMap;
map<uint16_t, uint32_t*> PXMTrojan::sBouncerCountMap;

PXMTrojan::PXMTrojan(PXScan *inScan, int inPort)
...
void
PXMTrojan::ProcessEvent(peak_stream s, int type)
  {
  char *line;
  int err;
...
void
PXMTrojan::EventCallback(peak_stream s, int type, void *context)
  {
  PXMTrojan *pxm = reinterpret_cast<PXMTrojan*>(context);
