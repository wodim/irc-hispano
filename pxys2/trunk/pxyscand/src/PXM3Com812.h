...
//
// $Id: PXM3Com812.h,v 1.1.1.1 2003/12/30 17:09:00 mbuna Exp $
//
#ifndef INCLUDED_PXM3COM812_H_
#define INCLUDED_PXM3COM812_H_

#include "PXScanModule.h"

#include <peak/peak.h>

class PXM3Com812 : public PXScanModule
  {
public:
  PXM3Com812(PXScan *inScan);
  virtual ~PXM3Com812();
...
protected:
  ...
  static uint32_t sProxyCount3;
  };

#endif // INCLUDED_PXM3COM812_H_
