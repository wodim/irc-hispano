 ...
 *
 * $Id: ircdreams.c 31 2007-07-18 11:39:31Z Hal9000 $
 *
 */
...
void moduleAddIRCDMsgs(void) {
    ...
    /* Vhost */
    m = createMessage("SA",        denora_event_chghost); addCoreMessage(IRCD,m);
    /* Rules */
    m = createMessage("RL",        denora_event_null); addCoreMessage(IRCD,m);
...
int DenoraInit(int argc, char **argv)
{
    ...
    moduleAddVersion("$Id: ircdreams.c 31 2007-07-18 11:39:31Z Hal9000 $");
