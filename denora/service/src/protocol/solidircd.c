 ...
 *
 * $Id: solidircd.c 388 2011-01-04 21:12:18Z hal9000 $
 *
...
void moduleAddIRCDMsgs(void)
{
    ...
    m = createMessage("AKILL",     denora_event_akill); addCoreMessage(IRCD,m);
    ...
    m = createMessage("SGLINE",    denora_event_sgline); addCoreMessage(IRCD,m);
    m = createMessage("SJOIN",     denora_event_sjoin); addCoreMessage(IRCD,m);
    m = createMessage("SS",        denora_event_ss); addCoreMessage(IRCD,m);
    ...
    m = createMessage("SVHOST",    denora_event_chghost); addCoreMessage(IRCD,m);
    m = createMessage("SVIDENT",   denora_event_chgident); addCoreMessage(IRCD,m);
    m = createMessage("SETIDENT",  denora_event_chgident); addCoreMessage(IRCD,m);
    m = createMessage("ELMER",     denora_event_null); addCoreMessage(IRCD,m);
    m = createMessage("SILLY",     denora_event_null); addCoreMessage(IRCD,m);
    m = createMessage("SHUN",      denora_event_null); addCoreMessage(IRCD,m);
    m = createMessage("NORMAL",    denora_event_null); addCoreMessage(IRCD,m);
    m = createMessage("CONOPS",    denora_event_null); addCoreMessage(IRCD,m);
