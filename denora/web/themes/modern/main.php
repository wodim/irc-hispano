<?php
// Modern Theme Main Layout for phpDenora 1.2.0
...
<div id="pd_frame">
  <div id="pd_header">
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td valign="middle"><a href="<?php echo $pd_neturl ?>"><img src="themes/modern/img/logo.png" alt="" id="logo" /></a></td>
        <td valign="middle"><table border="0" cellspacing="0" cellpadding="2">
            <tr align="center">
              <td class="topmenu"><a href="?m=h"><img src="themes/modern/img/home.png" alt="" /><br />
                <?php echo _TM_HOME; ?></a></td>
              <td class="topmenu"><a href="?m=n"><img src="themes/modern/img/network.png" alt="" /><br />
                <?php echo _TM_NETWORK; ?></a></td>
              <?php if ($pd_ennetgraphs == true || $pd_netsplit_graphs == true || $pd_searchirc_graphs == true) { ?>
              <td class="topmenu"><a href="?m=g"><img src="themes/modern/img/graphs.png" alt="" /><br />
                <?php echo _TM_GRAPHS; ?></a></td>
              <?php } ?>
              <td class="topmenu"><a href="?m=c"><img src="themes/modern/img/channels.png" alt="" /><br />
                <?php echo _TM_CHANS; ?></a></td>
              <td class="topmenu"><a href="?m=u"><img src="themes/modern/img/users.png" alt="" /><br />
                <?php echo _TM_USERS; ?></a></td>
              <td class="topmenu"><a href="?m=s"><img src="themes/modern/img/search.png" alt="" /><br />
                <?php echo _TM_SEARCH; ?></a></td>
              <td class="topmenu"><a href="?m=k"><img src="themes/modern/img/config.png" alt="" /><br />
      ...
      <tr>
        <td valign="top" id="pd_menutd"><div id="pd_menu">
          ...
          <div style="text-align:center;">
			...
			google_color_border = "f9f3df";
			google_color_bg = "f9f3df";
