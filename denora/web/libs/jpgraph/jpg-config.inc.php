...
// Created:     2004-03-27
// Ver:         $Id: jpg-config.inc.php 399 2010-05-29 12:55:46Z hal9000 $
//
...
if (isset($pd_cachedir)) { define("CACHE_DIR",$pd_cachedir); }
...
if (isset($pd_graphcache)) {
	define("USE_CACHE",$pd_graphcache);
}
else {
